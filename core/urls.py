...
urlpatterns = [
    ...
    path("inventory/product/add/",InventoryProductAddView.as_view(),name="inventory_product_add"),
    ...
    path("inventory/product-category/add/",ProductCategoryAddView.as_view(),name="product_category_add"),
